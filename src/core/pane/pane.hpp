...
// One command-history entry with a timestamp (design history-system §2).
// Canonical storage is per-pane (`PaneState.command_history`); the aggregator
// (`HistoryEntry`) adds window/tab/pane provenance on top.
